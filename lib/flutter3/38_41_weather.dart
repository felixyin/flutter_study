...
import 'weather/model_provider.dart';
import 'weather/model_command.dart';
import 'weather/weather_repo.dart';
import 'package:flutter/material.dart';
import 'weather/weather_repo.dart';
import 'weather/model_command.dart';
import 'weather/weater.dart';
import 'weather/model_provider.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    // var x = Location.locationUpdates(
  ...
  Widget build(BuildContext context) {
    ...
    ModelProvider.of(context).modelCommand.getGpsCommand.call();
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ...
          'Weather',
          style: TextStyle(
            fontSize: myLocale.languageCode.contains("es") || myLocale.languageCode.contains("ja")
                ? 15.0
                : 20.0,
          ),
        ),
        actions: <Widget>[
          Container(
            child: Center(
              child: RxLoader<bool>(
                radius: 20.0,
                commandResults: ModelProvider.of(context).modelCommand.getGpsCommand.results,
                dataBuilder: (context, data) => Row(
                      children: <Widget>[
                        ...
                        IconButton(
                          ...
                          onPressed: ModelProvider.of(context).modelCommand.getGpsCommand,
                        ),
                      ],
                    ),
          ...
          PopupMenuButton<int>(
            ...
            onSelected: (int item) {
              ModelProvider.of(context).modelCommand.addCitiesCommand(item);
            },
            itemBuilder: (context) {
              return menuNumbers
        ...
        children: <Widget>[
          Expanded(
            child: RxLoader<List<WeatherModel>>(
              radius: 30.0,
              commandResults: ModelProvider.of(context).modelCommand.updateWeatherCommand.results,
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: WidgetSelector(
                    buildEvents:
                        ModelProvider.of(context).modelCommand.updateWeatherCommand.canExecute,
                    onTrue: MaterialButton(
                      ...
                      child: Text('getData'),
                      onPressed: () => print('ok'),
                      // ModelProvider.of(context).modelCommand.updateLocationStreamCommand.call,
                    ),
                ...
                Expanded(
                  child: Column(
                    children: <Widget>[
                      SliderItem(
                        sliderState: true,
                        command: ModelProvider.of(context)
                        .modelCommand
                        .radioCheckedCommand,
                      ),
                      Container(
