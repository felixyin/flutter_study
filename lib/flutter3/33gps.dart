...
class _MyAppState extends State<MyApp> {
  ...
  void _printAll() {
    ...
    print(_startLocation["accuracy"]);
    print(_startLocation["altitude"]);
    print(_startLocation["speed"]);
    print(_startLocation["speed_accuracy"]); // Will always be 0 on iOS
  }
  ...
  Widget build(BuildContext context) {
    ...
    widgets.add(new Center(
        child: new Text(
            _startLocation != null ? 'Start location: $_startLocation\n' : 'Error: $error\n')));
    ...
    widgets.add(
        new Center(child: new Text(_permission ? 'Has permission : Yes' : "Has permission : No")));
